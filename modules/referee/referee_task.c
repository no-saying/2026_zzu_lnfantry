...
void MyUIInit()
{
    ...
    // UILineDraw(&UI_shoot_line[2], "sl2", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 800, 510, 1120, 510);
    // UILineDraw(&UI_shoot_line[3], "sl3", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 830, 480, 1090, 480);
    // UILineDraw(&UI_shoot_line[4], "sl4", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 870, 450, 1050, 450);

    //车辆基准线
    // UILineDraw(&UI_shoot_line[5], "sl5", UI_Graph_ADD, 7, UI_Color_Cyan, 2, 345, 0, 810, 510);
    // UILineDraw(&UI_shoot_line[6], "sl6", UI_Graph_ADD, 7, UI_Color_Cyan, 2, 1575, 0, 1110, 510);
    ...
    UICharDraw(&UI_State_sta[1], "ss1", UI_Graph_ADD, 8, UI_Color_Yellow, 15, 2, 150, 700, "wheel:");
    UICharRefresh(&referee_recv_info->referee_id, UI_State_sta[1]);
    UICharDraw(&UI_State_sta[2], "ss2", UI_Graph_ADD, 8, UI_Color_Orange, 15, 2, 150, 650, "leg:");
    ...
    UICharDraw(&UI_State_sta[4], "ss4", UI_Graph_ADD, 8, UI_Color_Pink, 15, 2, 150, 550, "power:");
    ...
    UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_ADD, 8, UI_Color_Orange, 15, 2, 270, 650, "hangoff");
    UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[2]);
    UICharDraw(&UI_State_dyn[3], "sd3", UI_Graph_ADD, 8, UI_Color_Pink, 15, 2, 270, 600, "off");
    UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[3]);
    UICharDraw(&UI_State_dyn[4], "sd4", UI_Graph_ADD, 8, UI_Color_Pink, 15, 2, 270, 550, "close ");
    UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[4]);

    // 底盘功率显示，静态
    UICharDraw(&UI_State_sta[5], "ss5", UI_Graph_ADD, 7, UI_Color_Green, 18, 2, 620, 230, "energy:");
    ...
    UIFloatDraw(&UI_Energy[3], "sd7", UI_Graph_ADD, 8, UI_Color_Green, 18, 2, 2, 1000, 230, 24000);
    // 能量条初始状态
...
static void MyUIRefresh(referee_info_t *referee_recv_info, Referee_Interactive_info_t *_Interactive_data)
{
    ...
    // wheel_flag
    if (_Interactive_data->Referee_Interactive_Flag.wheel_flag == 1)
    {
        switch (switch_flag)
        {
        case 1:
        {
            UICharDraw(&UI_State_dyn[1], "sd1", UI_Graph_Change, 8, UI_Color_Yellow, 15, 2, 270, 700, "on  ");
            break;
        }
        case 0:
        {
            UICharDraw(&UI_State_dyn[1], "sd1", UI_Graph_Change, 8, UI_Color_Yellow, 15, 2, 270, 700, "off   ");
            break;
        }
        }
        UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[1]);
    ...
    // leg
    if (_Interactive_data->Referee_Interactive_Flag.leg_flag == 1)
    {
        ...
        switch (_Interactive_data->leg_mode)
        {
        case 0:
        {
            UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_Change, 8, UI_Color_Orange, 15, 2, 270, 650, "hangoff ");
            break;
        }
        case 1:
        {
            UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_Change, 8, UI_Color_Orange, 15, 2, 270, 650, "hang    ");
            break;
        }
        case 2:
        {
            UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_Change, 8, UI_Color_Orange, 15, 2, 270, 650, "jump    ");
            break;
        }
        }
        UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[2]);
    ...
    {
        UICharDraw(&UI_State_dyn[4], "sd4", UI_Graph_Change, 8, UI_Color_Pink, 15, 2, 270, 550, _Interactive_data->super_cap_mode == 1 ? "open " : "close");
        UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[4]);
    ...
    if (_Interactive_data->Referee_Interactive_Flag.Power_flag == 1)
    {
        ...
        UIFloatDraw(&UI_Energy[3], "sd7", UI_Graph_Change, 8, UI_Color_Green, 18, 2, 2, 1000, 230, _Interactive_data->super_cap.buffer_energy * 1000);
        UILineDraw(&UI_Energy[2], "sd6", UI_Graph_Change, 8, UI_Color_Pink, 30, 720, 160, (uint32_t)750 + _Interactive_data->Chassis_Power_Data.chassis_power_mx * 3.3, 160);
        UIGraphRefresh(&referee_recv_info->referee_id, 2, UI_Energy[1], UI_Energy[2]);
        UIGraphRefresh(&referee_recv_info->referee_id, 1, UI_Energy[3]);
...
static void UIChangeCheck(Referee_Interactive_info_t *_Interactive_data)
{
    ...
    {
        _Interactive_data->Referee_Interactive_Flag.wheel_flag = 1;
        last_switch_flag = switch_flag;
    }

    if (_Interactive_data->leg_mode != _Interactive_data->leg_last_mode)
    {
        _Interactive_data->Referee_Interactive_Flag.leg_flag = 1;
        _Interactive_data->leg_last_mode = _Interactive_data->leg_mode;
    }
    ...
    if (_Interactive_data->super_cap.buffer_energy != _Interactive_data->last_super_cap.buffer_energy)
    {
        _Interactive_data->Referee_Interactive_Flag.Power_flag = 1;
        _Interactive_data->last_super_cap.buffer_energy = _Interactive_data->super_cap.buffer_energy;
    }
