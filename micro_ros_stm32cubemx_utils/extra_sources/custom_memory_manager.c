...
#ifndef MICROROS_TOTAL_HEAP_SIZE
#define MICROROS_TOTAL_HEAP_SIZE configTOTAL_HEAP_SIZE
#endif

/* Allocate the memory for the heap. */
static uint8_t ucHeap[ MICROROS_TOTAL_HEAP_SIZE ];
...
size_t uxAddress;
size_t xTotalHeapSize = MICROROS_TOTAL_HEAP_SIZE;
